package wkwkw.asek.ordercoffee;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void kurang (View view){
        ...
        int banyak= Integer.parseInt(inputJumlah.getText().toString());
        if(banyak==0){
            Toast.makeText(getApplicationContext(),"Pembelian kopi minimal 1 buah",Toast.LENGTH_SHORT).show();
        }
        else {
            int kurang = 1;
            int cost=5;
    ...
    public void order (View view){
        ...
        String pesan1 = "Jumlah kopi yang dipesan : "+banyak;
        pesan1 = pesan1+"\nTotal harga                  : $"+harga;
